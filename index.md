...
![](reference/figures/chewie-hex.png)
...
and check that those credentials and the cache are set up correctly
(using
[`chewie_health_check()`](https://permian-global-research.github.io/chewie/reference/chewie_health_check.md)).
By default the cache is set up in the `.chewie` folder in your home
directory. You can change this by running `chewie_cache_set()`.
...
![](reference/figures/README-show-find-data-1.png)
...
![](reference/figures/README-show-2a-data-1.png)
